...
COMMENT ON COLUMN EXERCICE.STATUS IS 'Activity status';
...
CREATE INDEX EXERCICE_I001 ON EXERCICE (STATUS, BUILDING_ID);
...
CREATE TABLE BUILDING_OWNER (
        ...
        CONSTRAINT BUILDING_OWNER_C002 FOREIGN KEY (OWNER_ID) REFERENCES CONTACT (ID));
