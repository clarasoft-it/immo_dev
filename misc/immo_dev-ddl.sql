...
COMMENT ON COLUMN BUILDING.ADDRESS1 IS 'Address 1';
COMMENT ON COLUMN BUILDING.ADDRESS2 IS 'Address 2';
COMMENT ON COLUMN BUILDING.CITY IS 'City';
COMMENT ON COLUMN BUILDING.DEPARTMENT IS 'Prov/State/Department';
COMMENT ON COLUMN BUILDING.CITY IS 'City';
COMMENT ON COLUMN BUILDING.COUNTRY IS 'Country';
COMMENT ON COLUMN BUILDING.ZIP IS 'Postal code';
COMMENT ON COLUMN BUILDING.PHONE1 IS 'Phone 1';
COMMENT ON COLUMN BUILDING.PHONE2 IS 'Phone 2';
COMMENT ON COLUMN BUILDING.FAX IS 'Fax';
COMMENT ON COLUMN BUILDING.EMAIL IS 'Email';
